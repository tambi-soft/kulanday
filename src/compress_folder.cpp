...
CompressFolder::CompressFolder(QObject *parent) : QObject(parent)
{
    
}

bool CompressFolder::compressFolder(QString sourceFolder, QString destinationFile)
{
...
bool CompressFolder::compress(QString sourceFolder, QString prefex)
{
...
bool CompressFolder::decompressFolder(QString sourceFile, QString destinationFolder)
{
    //validation
